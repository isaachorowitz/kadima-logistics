        ...
        <FadeUp>
            ...
            <div className="lg:col-span-2">
              <a href="/" className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-emerald rounded-[4px] flex items-center justify-center">
                  <span className="font-display text-navy font-black text-lg leading-none">
                    K
                  </span>
                </div>
              ...
              <p className="!text-white/95 text-sm leading-relaxed max-w-sm mb-6">
                Authorized DHL Reseller and multi-carrier shipping optimization
                partner. We audit, negotiate, and reduce shipping costs for
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="!text-white/90 text-xs">
              © {new Date().getFullYear()} Kadima Logistics. All rights
              reserved.
            </p>
