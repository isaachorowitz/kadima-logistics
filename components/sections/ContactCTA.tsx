...
import { auditFormSchema, type AuditFormData, carrierOptions, spendRanges } from "@/lib/validations";
        ...
        <Container narrow>
          <div className="text-center">
            ...
            <p className="text-white/70 text-lg max-w-md mx-auto">
              Our team will review your shipping data and get back to you within 1–2
              business days with a detailed savings analysis.
            </p>
          </div>
        </Container>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8">
              Submit your details and we&apos;ll analyze your current carrier agreements
              at no cost. Most businesses discover 20–30% in annual savings they didn&apos;t
              know were available.
            </p>
          ...
          <div className="bg-white rounded-[4px] p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
              ...
              <div>
                ...
                {errors.monthlySpend && (
                  <p className={errorClasses}>{errors.monthlySpend.message}</p>
                )}
              </div>
              ...
              <p className="text-xs text-body-text/50 text-center">
                We&apos;ll never share your data. Results within 1–2 business days.
              </p>
            </form>
          </div>
        </div>
