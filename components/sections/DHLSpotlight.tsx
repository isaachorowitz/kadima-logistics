...
export default function DHLSpotlight() {
  return (
    <section id="dhl" className="py-20 lg:py-28 bg-navy relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 bg-dhl-amber/10 border border-dhl-amber/30 rounded-[4px] px-4 py-2 mb-8">
              ...
              <span className="text-dhl-amber text-sm font-bold tracking-wide uppercase">
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-dhl-amber">Couldn&apos;t Get Alone</span>
            </h2>

            <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
              As an authorized DHL reseller, Kadima provides direct access to DHL Express
              rates that are typically reserved for high-volume enterprise shippers. Whether
              you&apos;re shipping 50 or 5,000 parcels a month, you get institutional pricing
          ...
          <div className="relative">
            <div className="bg-navy-light rounded-[4px] border border-white/10 p-8 lg:p-12">
              <div className="space-y-6">
                {/* Stat Cards */}
                <div className="bg-navy rounded-[4px] border border-white/10 p-6">
                  <div className="flex items-center gap-3 mb-2">
                    <Package className="w-5 h-5 text-dhl-amber" />
                    <span className="text-white/50 text-sm">DHL Express Coverage</span>
                  </div>
                  <p className="font-display text-3xl font-bold text-dhl-amber">220+</p>
                  <p className="text-white/50 text-sm">countries and territories</p>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-navy rounded-[4px] border border-white/10 p-5">
                    <p className="font-display text-2xl font-bold text-emerald">50–5K</p>
                    <p className="text-white/50 text-xs mt-1">parcels/month accepted</p>
                  </div>
                  <div className="bg-navy rounded-[4px] border border-white/10 p-5">
                    <p className="font-display text-2xl font-bold text-emerald">0</p>
                    <p className="text-white/50 text-xs mt-1">broker markups</p>
                  </div>
                </div>
